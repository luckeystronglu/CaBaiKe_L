...
/*
 ...
 limitacom.dingruan.vsins.network
 */
...
/**
 * 
 * 异步http请求 The AsyncHttpClient can be used to make asynchronous GET, POST, PUT
 * and DELETE HTTP requests in your Android applications. Requests can be made
 * with additional parameters by passing a {@link RequestParams} instance, and
...
public class AsyncHttpClient {
	...
	private ThreadPoolExecutor threadPool;//执行网络请求的线程池
	private final Map<Context, List<WeakReference<Future<?>>>> requestMap;// 异步回调引用
	private final Map<String, String> clientHeaderMap;//客户端的请求HeaderMap
	 ...
	 * [dictionary setObject:username forKey:@"username"]; [dictionary
	 * setObject:password forKey:@"password"]; [dictionary setObject:@"0"
	 * forKey:@"os_type"]
	 */
	...
	protected void sendRequest(DefaultHttpClient client,
		...
		// 统一添加文件头
//		uriRequest.addHeader("Content-Type", GlobalApplication.request_head);
